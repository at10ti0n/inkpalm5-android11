...
javac -source 8 -target 8 -bootclasspath "$AJ" -classpath "$AJ" -d build/cls build/gen/net/inkpalm/einktile/R.java build/gen/Props.java src/net/inkpalm/einktile/ModeTile.java src/net/inkpalm/einktile/RefreshTile.java src/net/inkpalm/einktile/RefreshReceiver.java src/net/inkpalm/einktile/WarmthTile.java src/net/inkpalm/einktile/LockWallpaperReceiver.java src/net/inkpalm/einktile/RotationTile.java
