...
"$BT/apksigner" sign --ks build/signing.jks --ks-pass pass:inkpalm --key-pass pass:inkpalm --out build/inkpalm-aod.apk build/aligned.apk
"$BT/apksigner" verify build/inkpalm-aod.apk
shasum -a 256 build/inkpalm-aod.apk
