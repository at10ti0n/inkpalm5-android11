...
#ifdef TW_CUSTOM_EPD_BACKEND
    // EPD105 owns a software surface. Never fall back to a hardware framebuffer.
    gr_backend = open_epd();
    if (!gr_backend)
        return -1;
