...
//hxm add
	DISP_LCD_SET_BRIGHTNESS_DUTYCYCLE = 0x112,
//end	
	/* ---- capture --- */
	...
	DISP_EINK_SET_GC_CNT = 0x407,
	DISP_EINK_SET_PANEL_VERSION = 0x408,
	DISP_EINK_SYNC = 0x40a,
	DISP_EINK_STATE = 0x40b,
	DISP_EINK_GET_ACTIVE_UPDATES = 0x40c,
	DISP_EINK_HELLO = 0x4fe,
};
