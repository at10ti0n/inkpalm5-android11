...
LOCAL_SHARED_LIBRARIES += libcutils liblog libutils libdl
endif
LOCAL_MODULE_TAGS := eng
LOCAL_MODULE := libminuitwrp

LOCAL_C_INCLUDES += $(LOCAL_PATH)/epd
LOCAL_CFLAGS += -DTW_CUSTOM_EPD_BACKEND -DEPD_USE_REAL_MINUI
LOCAL_EXPORT_C_INCLUDE_DIRS += $(LOCAL_PATH)/epd
